...
### 📊 开发动态
<div align="center">
  <img src="https://github-readme-activity-graph.vercel.app/graph?username=34204002&theme=tokyo-night&hide_border=true&area=true&from=2025-09-01&to=2026-09-01" width="98%"/>
</div>
...
### 🛠 常用技术栈
<div align="center">
  <img src="https://skillicons.dev/icons?i=java,spring,mysql,redis,rabbitmq,linux,git,nginx&perline=8&theme=dark" />
</div>

---

### 关于我
普普通通的大三工科生，日常就是学习、写代码、改bug，在Java后端的路上边踩坑边成长。

- 课内绩点年级前30%，英语六级通关，拿过蓝桥杯Java A组省一和国奖，算法基础还算扎实
- 目前在Java后端实习，接触了微服务和图数据库开发，从接口设计到线上问题排查都摸了个遍
- 写代码习惯规规矩矩，commit和注释都不会偷懒，对高并发、分布式相关的技术比较感兴趣
- 仓库会不定期更新自己的项目代码，慢慢打磨细节，把学到的东西落地成可运行的代码
